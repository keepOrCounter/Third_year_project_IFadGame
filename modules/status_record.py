...
class Player_status():
    def __init__(self, currentLocation:list[int,int] = [0,0], items:list[str] = [], \
        hp: int = 100, action_point: int = 100, currentAction = None) -> None:
...
class Events():
    def __init__(self, eventName: str, succeedCondition, reward, fail_penalty, \
        time_limit: int) -> None:
...
class Actions():
    def __init__(self, actionName: str, command_executed) -> None:
        pass
